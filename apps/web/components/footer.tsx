...
const footerSections = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/programa-partner", label: "Programa Partner" },
      { href: "/programa-afiliado", label: "Programa Afiliado" },
      { href: "/kwanza-camp", label: "Kwanza Camp" },
      { href: "/kwanza-awards", label: "Kwanza Awards" },
    ],
  },
  {
    title: "Comunidade",
    links: [
      ...
      { href: "/provincias", label: "Províncias" },
      { href: "/impacto-social", label: "Impacto Social" },
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/diretrizes-comunidade", label: "Diretrizes" },
