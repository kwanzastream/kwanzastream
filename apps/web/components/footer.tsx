        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-4 lg:mb-0">
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href="https://wa.me/244923456789" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-[var(--surface-2)] flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors" aria-label="WhatsApp">
              ...
              <a href="https://instagram.com/kwanzastream" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-[var(--surface-2)] flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors" aria-label="Instagram">
              ...
              <a href="https://twitter.com/kwanzastream" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-[var(--surface-2)] flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors" aria-label="Twitter/X">
