...
const MOCK: TransactionData[] = [{id:"1",type:"deposit",description:"Transacção Depósitos",amount:1000,date:"hoje",status:"completed"}]
  ...
  return (
    <div className="max-w-4xl mx-auto py-4 px-4 space-y-4">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold">Depósitos</h1>
      </div>
