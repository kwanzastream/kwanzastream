...
const MOCK: TransactionData[] = [{id:"1",type:"salos_received",description:"Transacção Salos Recebidos",amount:1000,date:"hoje",status:"completed"}]
  ...
  return (
    <div className="max-w-4xl mx-auto py-4 px-4 space-y-4">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold">Salos Recebidos</h1>
      </div>
